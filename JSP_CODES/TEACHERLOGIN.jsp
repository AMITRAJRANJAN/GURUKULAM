...
<html>
    ...
    <body class="bg-secondary">
        ...
        <div class=" my-5 mx-5">
            <form>
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-sm-2 col-form-label text-warning">Teacher id</label>
                    <div class="col-sm-10">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-outline-warning" type="submit">Login to Teacher Panel</button>
                </div>
            </form>
        </div>
